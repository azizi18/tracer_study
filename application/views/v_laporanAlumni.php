  ...
  <div class="content-inner">
    ...
    <div class="alert alert-info alert-dismissible" role="alert">
      ...
      <p style="font-family: verdana; font-size: 11pt">Grafik dapat ditampilkan untuk pertanyaan jenis pilihan, ganda, dan interval</p>
    </div>
    <!-- Forms Section-->
    <section class="forms">
      <div class="container-fluid">
                    ...
                    <div class="col-sm-9">
                      <select class="js-example-basic-single dropdown" id="" name="pertanyaanID" style="width: 100%;">
                        ...
                        <?php } elseif ($this->m_kuesioner->getKuesionerByID($kuesionerID)->nama_kuesioner == 'Pekerjaan') { ?>
                          <option value="gaji">Penghasilan/Gaji Pertama</option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
