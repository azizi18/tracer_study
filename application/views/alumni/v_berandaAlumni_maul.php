...
<div class="content-inner">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">Tracer Study <?php echo $this->m_master->getProdiByID($prodiID)->nama_prodi ?> Universitas</h5>
            </div>
            <div class="card-body">
  ...
  <script type="text/javascript">
    ...
    /*function exeAddPekerjaan_new() {
        
        var data = $('.exeAddPekerjaan_new').serialize();
        ...
        $.ajax({
            type: 'POST',
            data: data,
            url: "<?php echo base_url('alumni/Data/exeAddPekerjaan_new') ?>",
