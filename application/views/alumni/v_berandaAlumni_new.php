        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">Tracer Study <?php echo $this->m_master->getProdiByID($prodiID)->nama_prodi ?> Fakultas Teknik</h5>
            </div>
            <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  <div class="tab-content" id="myTabContent" style="overflow: hidden;">
                    ...
                    <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <div class="row">
                                    ...
                                    <div class="col-md-2">
                                      <p style="text-align: center;font-size: 15px">Sampai</p>
                                    </div>
                                    <div class="col-md-5">
                      ...
                      if ($cek > 0) { ?>
                        <center>
                          <h4 class="h4">Riwayat Pekerjaan Anda</h4>
                        </center>
                                  ...
                                  <?php if ($p->jenis == 'isian') { ?>
                                    <div class="form-group row">
                                      <?php if ($p->textarea == 'ya') { ?>
                                        <textarea class="form-control" name="isian_<?php echo $p->id ?>" <?php if ($p->required == 'yes') {
                                                                                                            echo "required";
                                                                                                          } ?> rows="5" placeholder="masukkan jawaban"></textarea>
                                      <?php } else { ?>
                                        <input type="text" placeholder="masukkan jawaban" <?php if ($p->required == 'yes') {
                                                                                            echo "required";
                                                                                          } ?> name="isian_<?php echo $p->id ?>" class="form-control">
                                      <?php }
                                    ...
                                    if ($jumlahPilihan > 5) { ?>
                                      <select name="pilihan_<?php echo $p->id ?>" <?php if ($p->required == 'yes') {
                                                                                    echo "required";
                                    ...
                                    <?php } else { ?>
                                      <?php foreach ($pilihanJawaban as $pj) {  ?>
                                        <div class="i-checks">
                                          <input id="option1" type="radio" value="<?php echo $pj->pilihan ?>" <?php if ($p->required == 'yes') {
                                                                                                                echo "required";
                                                                                                              } ?> name="pilihan_<?php echo $p->id ?>" class="radio-template">
                                      ...
                                      <tbody>
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            $skalaNilai = $this->m_kuesioner->getSkalaByPertanyaanID($p->id);
                                            foreach ($skalaNilai as $sn) { ?>
                                              <th><input type="radio" value="<?php echo $sn->nilai ?>" <?php if ($ps->required == 'yes') {
                                                                                                          echo "required";
                                                                                                        } ?> name="skala_<?php echo $ps->id ?>" class="radio-template"></th>
                                            <?php } //foreach skala nilai 
                                            ?>
                                          </tr>
    ...
    $(document).ready(function() { // Ketika halaman sudah siap (sudah selesai di load)
      ...
      $(".instansiID_C").change(function() { // Ketika user mengganti atau memilih data provinsi
        ...
        $.ajax({
          ...
          data: {
            instansiID: $("#instansiID_" + id_num).val()
