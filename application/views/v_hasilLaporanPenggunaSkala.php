        ...
        <div class="content-inner">
          ...
          <header class="page-header" style="background-color: #119db59c">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Laporan Kuesioner Pengguna</h2>
            </div>
          </header>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="row">
                      <?php 
                      $jumlahPilihan = $this->m_kuesioner->getSkalaByPertanyaanID($pertanyaan->id);
           ...
           <?php 
            ...
            if(count($grafik)>0)
            {
             foreach ($grafik as $informasi) {
              echo "['" .$informasi->nilai . "'," . $informasi->num ."],\n";
             }
            }
          ?>
         ]
