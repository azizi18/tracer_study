<body>
  <main>
    <div class="container" style="margin-top: 30px">
      <h3><b>Berita Alumni - Kegiatan</b></h3>
      ...
      <div class="row" style="margin-top: 20px">
        ...
        if ($berita == false) {
          ...
          echo "<div class='col-md-4'><p style='font-size:25px;color:red' align='center'>Tidak ada kegiatan</p></div>";
          echo "<div class='col-md-4'></div>";
        } else {
          foreach ($berita as $u) { ?>
            <div class="col-md-4">
              ...
              <div class="card" style="margin: 10px;max-height: 400px">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text" align="center">Oleh : <?php if ($u->userID == '1') {
                                                                ...
                                                                echo $this->m_berita->get_alumni($u->userID)->nama;
