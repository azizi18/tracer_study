      ...
      <div class="row" style="margin-top: 30px" >
        ...
        echo "
          <form method='' action='".base_url('berita_alumni/berita_saya')."'>
           <button class='btn' type='submit' style='background-color:#03626F;float:left' align='left'> <i class='fa fa-file-text-o' aria-hidden='true' style='margin-right: 10px'></i> Berita Saya</button>
         </form>
         ";
         }*/
      ?>
