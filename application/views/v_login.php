          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="info d-flex align-items-center">
                <div class="content">
                  <div class="logo">
                    <img src="<?php echo base_url(); ?>assets/template/img/logof.png" style="height: :200px;width:200px;margin-left: 50px;margin-bottom: 20px" class="img-fluid rounded-circle img-responsive">
                    <h2>Sistem Informasi Tracer Study</h2>
                  </div>
                  <p>FAKULTAS TEKNIK UNU NTB</p>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
              ...
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form method="post" action="<?php echo base_url('Login/exeLogin'); ?>" class="form-validate">
                    ...
                    <button id="login" class="btn btn-info">Masuk</button>
