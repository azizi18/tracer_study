      ...
      <div class="container-fluid">
        <div class="row bg-white has-shadow">
          <p align="justify" style="margin: 5px;font-size: 17px">
            <font face="cambria">
              Bapak/Ibu yang terhormat, saat ini kami sedang melakukan <i><b>Tracer Study</b></i> (penelusuran alumni) <b>Program Studi <?php echo $this->m_master->getProdiByID($prodiID)->nama_prodi ?></b> Fakultas Teknik UNU NTB. Adapun tujuan dari kegiatan ini adalah untuk mendapatkan basis data yang diperlukan dalam penyusunan Evaluasi Diri dalam rangka Akreditasi Program Studi. Berkaitan dengan hal tersebut, kami mohon Bapak/Ibu dapat mengisi kuesioner ini, data yang Bapak/Ibu isi dijamin kerahasiaannya. Untuk kerjasama dan bantuannya, kami mengucapkan banyak terima kasih. </font>
                    ...
                    foreach ($pertanyaan as $p) {
                      ...
                      ?>
                        <div class="form-group">
                          ...
                          <input type="text" name="isian_<?php echo $p->id ?>" placeholder="" <?php if ($p->required == 'yes') {
                                                                                                echo "required";
                                                                                              } ?> class="form-control">
                        </div>
