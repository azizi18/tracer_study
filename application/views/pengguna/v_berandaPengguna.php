          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Tracer Study Fakultas Teknik</h5>
              </div>
              <div class="card-body">
                <div class="col-sm-12">
