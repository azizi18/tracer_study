...
<header>
    ...
    <!--Jumbotron-->
    <div style="margin-bottom: 0px;margin-top: 0 !important;background-color:#03626F;height: 120px;padding-top: 10px !important;padding-right: 40px !important" class="jumbotron jumbotron-fluid">

        <div style="margin-left: 0px" class="container mt-2 mb-2">
            <div class="row">
                <div class="col-sm-1 mr-3">
                    <img style="height: 70px;width: 70px" src="<?php echo base_url(); ?>/assets/siluni//images/logox.png" width="1350px" class="image1 mt-2">
                </div>
                <div class="col-sm-5 mt-1">
                    <span class="inline-block">
                        <h4 style="margin-bottom: 0px" class="h4-reponsive mb-4 mt-1 white-text font-bold font2">Sistem Informasi Alumni</h4>
                        <h4 class="h4-reponsive mb-4 mt-1 white-text font-bold font2">UNIVERSITAS</h4>
                    </span>
                </div>
            </div>
        </div>
    ...
    <!--Jumbotron-->
    <div>
        <nav style="background-color: #119db59c" class="navbar navbar-expand-lg navbar-dark">
            ...
            <div style="float: left;margin-left: 30px" class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class='nav-item dropdown'>
                        ...
                        <div class=' dropdown-content'>
                            <!-- <a class='dropdown-item' href="<?php //echo base_url('Statistik/alumni/'.'1') 
                                                                ?>">Ilmu Komputer</a> -->
                            <?php foreach ($prodi as $p) { ?>
                    ...
                    <li class='nav-item dropdown'>
                        ...
                        <div class=' dropdown-content'>
                            <a class='dropdown-item' href='<?php echo base_url(); ?>'>Sistem Informasi</a>
                            <a class='dropdown-item' href='<?php echo base_url(); ?>'> Teknik Lingkungan </a>
