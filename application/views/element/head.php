...
<head>
    ...
    <title>Tracer Study FT-UNUNTB</title>
    <link rel="icon" href="<?php echo base_url('assets/template/img/logof.png') ?>" type="image/x-icon">
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/template/css/style.green.css" id="theme-stylesheet">
