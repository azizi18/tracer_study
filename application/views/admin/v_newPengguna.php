        <div class="content-inner">
          ...
          <div class="alert alert-info alert-dismissible" role="alert">
            ...
            <strong><i class="fa fa-warning"></i> Perhatian!</strong>
            <p style="font-family: verdana; font-size: 11pt">Pengisian kuesioner untuk pengguna alumni dilakukan melalui link pada tabel dibawah ini, copy link tersebut kemudian kirimkan melalui email masing-masing pengguna dan untuk pengisian kuesioner bagi pengguna alumni yang belum terdaftar dilakukan melalui link berikut:</p> <button class="btn btn-sm btn-dark" onclick="copyFunction2()">Link Kuesioner Pengguna yang Belum Terdaftar</button>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <?php if ($p->id_instansi == '0' || $p->id_instansi == NULL) {
                                      ...
                                      echo $this->m_master->getInstansiByID($p->id_instansi)->nama_instansi;
                                    } ?>
                                  </td>
                                  ...
                                  <td width="100px">
                                    ...
                                    if ($p->id_instansi != Null) {
                                      ...
                                      <a href="<?php echo base_url('admin/Pengguna/lihatAlumni/' . $p->id) ?>" class="btn btn-info btn-sm">
                                        Lihat <span class="badge badge-light" style="color: #E62004"><?php if ($newAlumni != 0) {
                                                                                                        echo "+" . $newAlumni;
                                                                                                      }  ?></span>
                                      </a>
                                    <?php } ?>
                                  ...
                                  <td>
                                    <div class="i-checks">
                                      <input name="tandai<?php echo $p->id ?>" type="checkbox" <?php if ($p->tandai == 'checked') {
                                                                                                  echo 'checked=""';
