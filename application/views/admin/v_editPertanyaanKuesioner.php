                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <label class="radio-inline" style="margin-right: 8px">
                        <input type="radio" value="ya" <?php if ($pr->inputBox == 'ya') {
                                                          echo 'checked=""';
                                                        } ?> name="inputBox" class="radio-template"> Ya
                      </label>
                      <label class="radio-inline">
                        <input type="radio" value="tidak" <?php if ($pr->inputBox == 'tidak') {
                                                            echo 'checked=""';
                                                          } ?> name="inputBox" class="radio-template"> Tidak
                      </label>
                    </div>
                  </div>
                  <div class="line"></div>
