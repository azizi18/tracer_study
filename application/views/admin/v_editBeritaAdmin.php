 ...
 <div class="content-inner">
   ...
   <div class="breadcrumb-holder container-fluid">
     <ul class="breadcrumb">
       <li class="breadcrumb-item"><a href="<?php echo site_url('admin/Berita') ?>">Berita</a></li>
     </ul>
   </div>
       ...
       <div class="row">
         ...
         <div class="col-lg-12">
           <div class="card">
             ...
             <div class="card-body">
               <p></p>
               <form method="post" action="<?php echo base_url(); ?>admin/Berita/exeUpdateBerita" enctype="multipart/form-data" class="form-horizontal">
