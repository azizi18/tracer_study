<div class="content-inner">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group btn-group-toggle">
                            <form action="<?php echo base_url('admin/Berita/updateBerita/' . $b->id) ?>"><button type="submit" class="btn btn-warning btn-sm"><i class="far fa-edit"></i></button></form>
  ...
  <script type="text/javascript">
    ...
    function deletep() {
      window.location.href = "<?php echo base_url(); ?>admin/Berita/hapusBeritaSaya/" + p_id;
    }
