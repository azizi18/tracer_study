        <div class="content-inner">
          ...
          <header class="page-header" style="background-color: #119db59c">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Kelola Kaprodi</h2>
            </div>
          </header>
            ...
            <div role="document" class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 id="exampleModalLabel" class="modal-title">Ganti Kaprodi <?php echo $this->m_master->getProdiByID($prodiID)->nama_prodi ?></h4>
